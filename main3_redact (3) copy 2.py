...
class PyGameWidget(QWidget):
    ...
    def __init__(self, game_state, parent=None):
        ...
        try:
            ...
            self.bow_img = pygame.transform.scale(self.bow_img, (40, 40))
    ...
    def update_game(self):
        ...
        if self.game_state.is_attacking:
            ...
            attack_radius = 10  # Розмір кружка
            ...
            self.surface.blit(attack_text, (attack_x + 15, attack_y - 10))
    ...
    # Перевіряємо чи є вороги
        ...
        if Qt.Key_Space in self.keys_pressed and not self.game_state.is_attacking:
            ...
            if closest_foe:
                ...
                damage = int(damage)  # Переводимо в ціле число, щоб уникнути дробового здоров'я
...
class GameInterface(QMainWindow):
    def __init__(self):
        ...
        self.enemy_positions = {
            "lg_00.png": (250, 300),  # координати для першої кімнати
            "lg_01.png": (250, 50),  # координати для другої кімнати
            "lg_02.png": (250, 500)   # координати для третьої кімнати
        }
